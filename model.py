...
FREQ_DIST_FILE = 'dataset/freqdist.pkl'
BI_FREQ_DIST_FILE = 'dataset/freqdist-bi.pkl'
TEST_PROCESSED_FILE = 'dataset/data_set_test_preprocessed.csv'
TRAIN_PROCESSED_FILE = 'dataset/data_set_train_preprocessed.csv'
